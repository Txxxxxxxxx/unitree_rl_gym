...
from legged_gym.envs.hustBot.hustBot_config import HustBotRoughCfg, HustBotRoughCfgPPO
from legged_gym.envs.hustBot.hustBot_env import HustBotRobot
...
task_registry.register( "hustBot", HustBotRobot(), HustBotRoughCfg(), HustBotRoughCfgPPO())
